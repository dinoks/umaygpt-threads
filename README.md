...
Расписание: вторник, четверг, суббота в 11:00 по Алматы.
...
- **Publish Threads posts** — крутится вт/чт/сб в 06:00 UTC (= 11:00 Алматы)
...
- Берёт ближайший вт/чт/сб в 11:00 Алматы
...
- **4 поста в неделю** (вт/чт/сб обычные, пт вечером антипример) — золотая середина
