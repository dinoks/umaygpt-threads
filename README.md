...
Расписание: вторник, среда, четверг в 11:00 по Алматы.
...
- **Publish Threads posts** — крутится вт/ср/чт в 06:00 UTC (= 11:00 Алматы)
...
- Берёт ближайший вт/ср/чт в 11:00 Алматы
...
- **4 поста в неделю** (вт/ср/чт обычные, пт вечером антипример) — золотая середина
